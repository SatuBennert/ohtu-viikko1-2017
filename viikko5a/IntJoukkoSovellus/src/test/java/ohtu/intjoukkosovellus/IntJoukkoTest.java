...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.lukuKuuluuJoukkoon(10));
        assertFalse(joukko.lukuKuuluuJoukkoon(5));
        assertTrue(joukko.lukuKuuluuJoukkoon(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.lukuKuuluuJoukkoon(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.lukuKuuluuJoukkoon(11));
        joukko.poista(11);
        assertFalse(joukko.lukuKuuluuJoukkoon(11));
    ...
    public void leikkausToimii(){
        ...
        joukko2.lisaa(10);
        joukko2.lisaa(3);
        assertEquals(joukko2.toString(), joukko.toString());
